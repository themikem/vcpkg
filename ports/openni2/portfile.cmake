...
file(INSTALL ${CMAKE_CURRENT_LIST_DIR}/FindOpenNI2.cmake DESTINATION ${CURRENT_PACKAGES_DIR}/share/openni2)

# Deploy Script
file(INSTALL ${CMAKE_CURRENT_LIST_DIR}/openni2deploy.ps1 DESTINATION ${CURRENT_PACKAGES_DIR}/bin/OpenNI2)
file(INSTALL ${CMAKE_CURRENT_LIST_DIR}/openni2deploy.ps1 DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin/OpenNI2)

# Handle copyright
file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/openni2 RENAME copyright)